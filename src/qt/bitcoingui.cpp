    ...
    spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Ecash Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(bool fIsTestnet)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Ecash address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and ecash: URIs)"));
    ...
    if (!fIsTestnet)
        aboutAction = new QAction(QIcon(":/icons/bitcoin"), tr("&About Ecash Core"), this);
    else
        aboutAction = new QAction(QIcon(":/icons/bitcoin_testnet"), tr("&About Ecash Core"), this);
    aboutAction->setStatusTip(tr("Show information about Ecash"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Ecash"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Ecash addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Ecash addresses"));
    ...
    openAction->setStatusTip(tr("Open a ecash: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setStatusTip(tr("Show the Ecash Core help message to get a list with possible Ecash command-line options"));
...
void BitcoinGUI::createTrayIcon(bool fIsTestnet)
{
    ...
    if (!fIsTestnet)
    {
        trayIcon->setToolTip(tr("Ecash client"));
        trayIcon->setIcon(QIcon(":/icons/toolbar"));
    }
    else
    {
        trayIcon->setToolTip(tr("Ecash client") + " " + tr("[testnet]"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Ecash network", "", count));
}
...
{
    QString strTitle = tr("Ecash"); // default title
